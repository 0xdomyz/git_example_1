...
- The `no_vcs` folder stores artefacts of workflow without VCS.
...
## Version 1
1. Simulate making changes by copying content of `no_vcs/version1_step1` to project root.
2. \[VCS\] In git gui, add all changes and make a commit, Push up the changes to remote.
3. Simulate making more changes by copying content of `no_vcs/version1_step2` to project root.
...
## Version 2
1. Simulate making large changes by copying content of `no_vcs/version2` to project root.
